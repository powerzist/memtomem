        ...
        with Vertical(classes=f"modal-dialog help-dialog {self.border_class}".strip()):
            ...
            with VerticalScroll(classes="modal-body"):
                yield Static(
                    ...
                    "EDIT & CLIPBOARD\n"
                    "  Ctrl+C            Copy explicit selection (editable or read-only)\n"
                    "  Ctrl+X            Cut selected text in active visible editor only\n"
                    "  Ctrl+V            Paste into active visible editor only\n"
                    "  Ctrl+Shift+V / Shift+Insert  Compatibility paste aliases\n"
                    "  No selection: Copy/Cut do nothing\n"
                    "  Read-only text: Cut/Paste do nothing\n"
                    "  Hidden, inactive, or modal-background widgets are never targeted\n\n"
                    "MOUSE & TERMINALS\n"
                    "  F6 or Alt+M       Toggle MOUSE:TUI / MOUSE:OS\n"
                    "  MOUSE:TUI         Widget interaction and TUI text selection\n"
                    "  MOUSE:OS          Terminal-native selection, copy, and paste\n"
                    "  Windows Terminal: in MOUSE:TUI, hold Shift while dragging for OS selection\n"
                    "  OSC 52 copy depends on terminal support and permission;\n"
                    "  otherwise use terminal-native paste or MOUSE:OS\n\n"
                    "GLOBAL\n"
